...
def main(args):
    ...
    audio_clips_list = []
    p808_model_path = os.path.join('/home/dsi/levidan2/code/MVDR/DNS/DNSMOS', 'model_v8.onnx')

    if args.personalized_MOS:
        primary_model_path = os.path.join('/home/dsi/levidan2/code/MVDR/DNS/pDNSMOS', 'sig_bak_ovr.onnx')
    else:
        primary_model_path = os.path.join('/home/dsi/levidan2/code/MVDR/DNS/DNSMOS', 'sig_bak_ovr.onnx')
...
def test_DNSMOS(dir, csv_path,epoch):
    dir=dir+'wavs_epoc_'+str(epoch)
    if not os.path.exists(csv_path):
        os.makedirs(csv_path)
    csv_path = csv_path+'DNSMOS_epoc_'+str(epoch)+'.csv'
    ...
    parser.add_argument('-o', "--csv_path", default=csv_path, help='Dir to the csv that saves the results')
