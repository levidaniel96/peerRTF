...
if __name__=="__main__":
    personalized_MOS_or_regular = "--personalized_MOS"
    T60 = '100ms'
    type='si_sdr_on_ref' 
    parser = argparse.ArgumentParser()
    dir='/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+T60+'/graphs_MIRAGE/results_128_256_to_128_256/model_graph/results_'+type+'/num_layers_3_dropout_0.5_activation_relu_activation_out_tanh_tanh_alpha_0.1_batch_norm_False/results_long/wavs/'
    #dir='/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+T60+'/res_MP_new/wavs_long/'
    parser.add_argument('-t', "--testset_dir", default=dir, 
                        help='Path to the dir containing audio clips in .wav to be evaluated')
    parser.add_argument('-o', "--csv_path", default='csv/csv_'+T60+'_'+type+'_'+personalized_MOS_or_regular+'.csv', help='Dir to the csv that saves the results')
    parser.add_argument('-p', personalized_MOS_or_regular, action='store_true', 
