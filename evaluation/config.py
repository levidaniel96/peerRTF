...
class Paths:
    ...
    path_AIRs: str            # Path to the AIRs data
    path_AIRs_mirage_OOG: str   # Path to the AIRs data
    path_pink_noise: str        # Path to the pink noise data
    save_data_path: str         # Path to save the data
    test_RTFs_path : str        # Path to save the test RTFs
    RTFs_tensor_train_path: str # Path to save the training RTFs  
    save_graphs_path: str       # Path to save the graphs
    save_wav_dir: str           # Path to save the wav files
@dataclass
class Params:
